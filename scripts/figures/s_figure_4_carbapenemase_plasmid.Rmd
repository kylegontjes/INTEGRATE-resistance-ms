...
```{r}
ggsave(filename = "./Project_INTEGRATE/Analysis/Resistance_dynamics/INTEGRATE-resistance-ms/figures/s_figure_4_carbapenemase_plasmid.png",plot=gghtmp,width = 7.125,height = 5.25,dpi=900,bg = 'white')
```