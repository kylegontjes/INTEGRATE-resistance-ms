...
# Print & Save
```{r,message=F,error=F,warning=F,fig.width=9,fig.height=4}
figure
```

```{r}
ggsave(plot = figure, filename = "./figures/s_figure_10_cross_resistance.png", width = 9, height = 4, bg = "white",dpi=900)
```