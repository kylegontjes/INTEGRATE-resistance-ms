---
title: "Supplemental Figure 6: Cross-resistance"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
# Print & Save
```{r,message=F,error=F,warning=F,fig.width=8.5,fig.height=4}
figure
```

```{r}
ggsave(plot = figure, filename = "./Project_INTEGRATE/Analysis/Resistance_dynamics/INTEGRATE-resistance-ms/figures/s_figure_6_resistance_MIC_correlations.png", width = 8.75, height = 4, bg = "white",dpi=900)
```