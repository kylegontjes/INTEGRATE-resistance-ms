---
title: "Supplemental Figure 6: Resistance histograms"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
```{r}
ggsave(plot = histogram_figs, filename = "./figures/s_figure_6_resistance_histograms.png", width = 16.5, height = 13.2, bg = "white",dpi=900)
```