...
# Create figure
```{r,fig.width=8.5,fig.height=7.555556}
...
ggsave(filename = "./figures/figure_4_resistance_comparisons.png", plot=figure4, width = 8.5, height = 7.555556, dpi=900, bg = 'white')
```