---
title: "Supplemental Figure 12: MIC correlation"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
```{r}
ggsave(plot = corrfig, filename = "./figures/s_figure_12_resistance_MIC_correlations.png", width = 7.25, height = 7.25, bg = "white",dpi=900)
```
