...
mobtyper_prop <- mobtyper_prop %>% arrange(KPC_plasmid)  
...
mobtyper_prop_ST258$KPC_plasmid <- factor(mobtyper_prop_ST258$KPC_plasmid,levels = get_factor_order_plasmid(mobtyper_prop_ST258,'KPC_plasmid'))
mobtyper_prop_ST258 <- mobtyper_prop_ST258 %>% arrange(KPC_plasmid)  
