---
title: "Supplemental Figure 11: Resistance histograms"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
# Save figure
```{r}
ggsave(plot = histogram_figs, filename = "./figures/s_figure_11_resistance_histograms.png", width = 9.75, height = 9.75, bg = "white",dpi=900)
```