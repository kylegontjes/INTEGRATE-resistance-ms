---
title: "Supplemental Figure 7: Plasmid data"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
```{r} 
B <- ggplot(data=mobtyper_merged %>% subset(primary_cluster_id %in% KPC_plasmids) %>% subset(carbapenemase_plasmid==1),aes(x=primary_cluster_id,fill=carbapenemase_md)) + geom_bar(stat='count')  + carbapenemase_scale_2_row + 
...
# Save figure
```{r}
ggsave("./figures/s_figure_7_mobtyper_plasmid_overview.png",plot=figure, units='in',height=18.75,width=15,dpi=900,bg='white')
```
