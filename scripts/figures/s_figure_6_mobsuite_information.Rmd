...
B <- ggplot(data=mobtyper_merged %>% subset(primary_cluster_id %in% KPC_plasmids) %>% subset(carbapenemase_plasmid==1),aes(x=primary_cluster_id,fill=carbapenemase_md)) + geom_bar(stat='count')  + genotype_scale + 
