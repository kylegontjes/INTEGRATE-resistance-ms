---
title: "Supplemental Figure 1: Carbapenemase resistance mutations"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
```{r}
ggsave(filename = "./figures/s_figure_1_carbapenem_resistance_associated_genotypes_count.png",plot=figure,width = 8,height = 12,dpi=900,bg = 'white')
```
