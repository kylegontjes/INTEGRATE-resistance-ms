...
# Load omp matrix
```{r}
carb_omp <-  readRDS("./data/carbapenemase_content/carbapenem_resistance_genotype_content_merged_first_clinical_CRKP_isolate_datasets.RDS")
``` 
...
```{r}
ggsave(filename = "./figures/s_figure_4_carbapenem_resistance_associated_genotypes_phylogeny.png",plot=figure, width = 11,height = 11,dpi=900,bg = 'white')
``` 
