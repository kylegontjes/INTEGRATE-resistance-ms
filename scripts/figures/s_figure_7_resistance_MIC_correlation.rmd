---
title: "Supplemental Figure 7: MIC correlation"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
```{r}
ggsave(plot = corrfig, filename = "./figures/s_figure_7_resistance_MIC_correlations.png", width = 6.25, height = 5.25, bg = "white",dpi=900)
```
