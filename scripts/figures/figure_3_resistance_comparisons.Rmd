---
title: "Figure 3: Differences in resistance"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
A <- algorithm(overall_df = df_kpn,comparitor = 'study',df1 = df_kpn_201415,df2 = df_kpn_202123,df1name = '2014-15',df2name = '2021-23',population = "Both studies")
A
```

# B. Kpneumoniae ST258 2014-15 vs. 2021-23
```{r}
df_kpn_ST258 <- subset(df,Species == "Klebsiella pneumoniae" & ST=='258')
...
df_kpn_202123$ST258 <- ifelse(df_kpn_202123$ST == '258' & df_kpn_202123$Species == "Klebsiella pneumoniae" , T,F)
...
figure3 <- cowplot::plot_grid(A + theme(legend.position='none'),B + theme(legend.position='none'),C + theme(legend.position='none'),legends,labels = c("A", "B","C", ""))
 
figure3
```

```{r,fig.width=17,fig.height=10.5}   
ggsave(filename = "./Project_INTEGRATE/Analysis/Resistance_dynamics/INTEGRATE-resistance-ms/figures/figure_3_resistance_comparisons.png",plot=figure3,width = 8.5,height = 7.25,dpi=900,bg = 'white')
```