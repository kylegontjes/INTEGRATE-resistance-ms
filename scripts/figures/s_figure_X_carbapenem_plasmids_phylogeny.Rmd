...
```{r}
ggsave(filename = "./Project_INTEGRATE/Analysis/Resistance_dynamics/INTEGRATE-resistance-ms/figures/s_figure_X_carbapenem_plasmids_phylogeny.png",plot=A,width = 9.25,height =19 ,dpi=900,bg = 'white')
```