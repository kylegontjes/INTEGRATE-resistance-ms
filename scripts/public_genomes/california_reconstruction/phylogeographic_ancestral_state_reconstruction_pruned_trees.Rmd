---
title: "phylogeographic_ancestral_state_reconstruction_pruned_trees"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
names(CA_asr) <- STs
saveRDS(CA_asr,"./data/public_genomes/california_reconstruction/california_phylogeographic_reconstruction_asr_objs_pruned.RDS")
```
...
saveRDS(CA_asr_cluster,"./data/public_genomes/california_reconstruction/california_phylogeographic_reconstruction_clustering_pruned.RDS")
```