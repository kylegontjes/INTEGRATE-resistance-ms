---
title: "Results section 8: Differences among taxonomic groups"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
## Differences in resistance across ST258 isolates
...
##  Differences in resistance across 2021-23 ST258 vs 2021-23 not ST258

```{r}     
lapply(resistance_vars,FUN=get_frequency_stats_compare,df=df_202123,comparitor='ST258') %>% do.call(rbind,.)%>% favorite_kable() 
```
