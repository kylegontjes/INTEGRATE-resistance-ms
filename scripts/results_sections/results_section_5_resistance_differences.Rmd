...
# Load data
```{r}
df <- readRDS("~/Desktop/gl_nfs/Project_INTEGRATE/Analysis/Resistance_dynamics/2025-09-18_master_kpn_first_isolate_dataset_curation/results/CA_CRE_metadata_091825.RDS")  
...
at_least_one_missing <- df_202123 %>% subset(isolate_no %in% c(na_data %>% subset(.>0) %>% names()))

write_csv(at_least_one_missing,"~/Desktop/gl_nfs/Project_INTEGRATE/Analysis/Resistance_dynamics/2025-11-05_missing_resistance/results/INTEGRATE_missing_at_least_one_resistance_entry_110525.csv")
