...
convert_tableone_into_df(dataset=df ,vars = c("source_simplified","blood","other","resp","urine","wound"),strata='study',outcome_names = c('2014-15',"2021-23"),factorVars = c("source_simplified","blood","other","resp","urine","wound"),exact = c("other")) %>% favorite_kable()
