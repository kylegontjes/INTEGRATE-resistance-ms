...
gontjesr::convert_tableone_into_df(dataset=df %>% subset(KPC_plasmid != "No carbapenemase"),vars = "KPC_plasmid",strata='study',outcome_names = c("2021-23",'2014-15')) %>% favorite_kable()
```
...
gontjesr::convert_tableone_into_df(dataset=df %>% subset(ST=='258' & KPC_plasmid != "No carbapenemase"),vars = "KPC_plasmid",strata='study',outcome_names = c("2021-23",'2014-15')) %>% favorite_kable()
```
