---
title: "Results section 4: Taxonomy"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
convert_tableone_into_df(dataset=df_202123,vars='Species_ST')
...
convert_tableone_into_df(dataset=df_201415,vars='Species_ST')
```

# Did differences exist among prevalence of existing lineages (ST258 and ST17)
```{r}
convert_tableone_into_df(dataset = df,vars = c("ST258","ST17"),factorVars = c("ST258","ST17"),strata='study',outcome_names = c("2014-15","2021-23"),exact = "ST17")
```
...
1. Phylogenetic events: 14 

2. Singletons: 7 (6 public & 1 PCMP_H)
...
c. 6 involve public isolates: 4 with all, 1 w/ PCMP_H, 1 w/ INTEGRATE
...
2. Singletons: 8 (5 public + 3 INTEGRATE)

3. Clusters: 6 clusters

a. 4 involve INTEGRATE + public isolates 
...
a. Both involve INTEGRATE + public genomes. One is very large and another is small
