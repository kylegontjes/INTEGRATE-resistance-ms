---
title: "Results section 5: Carbapenemase data"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
df$blactamase_non_carbapenmase_bin <- df$blactamase_non_carbapenemase != 'No blactamase' 
```
...
df$non_carbapenemase_blactam_andor_omp_mutation <- df$blactamase_non_carbapenmase_bin==T | df$porin_mutation == T
df$non_carbapenemase_blactam_and_omp_mutation <- df$blactamase_non_carbapenmase_bin==T & df$porin_mutation == T
```  

# Differences across study periods in carbapenemase content

```{r}
convert_tableone_into_df(dataset = df,vars = c('blaKPC_presence',"blaNDM","blaOXA",'carbapenemase','no_carbapenemase',"porin_mutation","OmpK35_mutation","OmpK36_mutation",'non_carbapenemase_blactam_and_omp_mutation','non_carbapenemase_blactam_andor_omp_mutation'),strata = 'study',outcome_names = c("2014-15","2021-23"),factorVars = c('carbapenemase',"blaNDM","blaOXA",'no_carbapenemase',"porin_mutation","OmpK35_mutation","OmpK36_mutation",'non_carbapenemase_blactam_andor_omp_mutation','non_carbapenemase_blactam_and_omp_mutation'),exact = "carbapenemase",'non_carbapenemase_blactam_and_omp_mutation') %>% favorite_kable()
```

# Differences among non-carbapenemase-harboring genomes

```{r}
df_nocarb <- df %>% subset(carbapenemase == 'No carbapenemase')

convert_tableone_into_df(dataset = df_nocarb,vars = c('blaKPC_presence',"blaNDM","blaOXA",'carbapenemase',"porin_mutation","OmpK35_mutation","OmpK36_mutation",'non_carbapenemase_blactam_and_omp_mutation','blactamase_non_carbapenmase_bin','non_carbapenemase_blactam_andor_omp_mutation'),strata = 'study',outcome_names = c("2014-15","2021-23"),factorVars = c('carbapenemase',"blaNDM","blaOXA","porin_mutation","OmpK35_mutation","OmpK36_mutation",'non_carbapenemase_blactam_and_omp_mutation','blactamase_non_carbapenmase_bin','non_carbapenemase_blactam_andor_omp_mutation'),exact =c('carbapenemase',"blaNDM","blaOXA",'no_carbapenemase',"porin_mutation","OmpK35_mutation","OmpK36_mutation",'non_carbapenemase_blactam_and_omp_mutation','blactamase_non_carbapenmase_bin','non_carbapenemase_blactam_andor_omp_mutation')) %>% favorite_kable()
```
