---
title: "PENN blaKPC 2014-15 CA LTACH isolate collection curation"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
# Functions
setwd("./Project_INTEGRATE/Analysis/Resistance_dynamics/INTEGRATE-resistance-ms")
...
## Participant 13 had >1 isolate. Although the age was accurate (i.e., age different correlated with collection date difference), the two isolates had the same admit date, which suggests a possible issue with admit and discharge data
```{r}
...
# Prioritize ST data via kleborate
```{r}
