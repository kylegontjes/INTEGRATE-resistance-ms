...
df_2014_15%>% subset(participant_id %in% wrong_Cx_data$Patient_ID) %>% select(isolate_no,Patient_ID,Cx_date,admit_date,discharge_date,LOSbeforeCx,LOS_after_cx)  %>% gontjesr::favorite_kable()
