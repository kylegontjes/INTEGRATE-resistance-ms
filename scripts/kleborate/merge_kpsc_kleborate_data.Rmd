---
title: "Merge Kleborate data and curate matrix"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
# Merged Kleborate dataset (Kpnsc)
```{r}
...
# Matrix of OmpK36 mutations for future usage (e.g., focus on truncations)

Note: We'll use AMRFinder's insertion data, as that's more up to date

```{r}
rownames(kleborate_joint) <- kleborate_joint$isolate_no
kleborate_matrix <- get_presence_absence_matrix(df = kleborate_joint,variable = 'Omp_mutations') %>% as.data.frame
