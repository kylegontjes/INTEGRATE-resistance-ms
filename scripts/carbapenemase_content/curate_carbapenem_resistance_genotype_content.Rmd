---
title: "Curate betalactamase and porin mutation matrix"
author: "Kyle Gontjes"
date: "`r Sys.Date()`"
...
# Curate beta-lactamase genotype list from AMRFinder
...
# Load kleborate matrix

1. Remove GD and TD insertion, as we're using amrfinder's curated insertion data
...
# Merge b-lactamase + insertion data with Kleborate matrix
...
write.csv(df_carb_omp,"./data/carbapenemase_content/carbapenem_resistance_genotype_content_merged_datasets.csv",row.names = T) 
```

# First isolate per quarter dataset curation
...
# Beta-lactamase counts genotpyes
...
write.csv(df_carb_omp_first,"./data/carbapenemase_content/carbapenem_resistance_genotype_content_merged_first_clinical_CRKP_isolate_per_quarter.csv",row.names = T)
```
