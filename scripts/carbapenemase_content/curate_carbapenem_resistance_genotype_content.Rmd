...
df_first <- readRDS("./data/dataset/CA_LTACH_first_clinical_CRKP_genomes_merged_studies_metadata.RDS")   
```
...
```{r}
saveRDS(df_carb_omp_first,"./data/carbapenemase_content/carbapenem_resistance_genotype_content_merged_first_clinical_CRKP_isolate_datasets.RDS")
```
