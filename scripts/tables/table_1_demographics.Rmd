...
```{r}
table <-  convert_tableone_into_df(dataset = df_w_metadata, vars = c("participant_age_at_first_enc","participant_sex","participant_race","participant_ethnicity","non_hispanic_white",'source_simplified'), factorVars = c("participant_sex","participant_race","participant_ethnicity","non_hispanic_white",'source_simplified'),strata='study',outcome_names = c("2014-15","2021-23"))
